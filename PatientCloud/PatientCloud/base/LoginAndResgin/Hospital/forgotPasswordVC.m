...
@interface forgotPasswordVC ()<forgotPassviewdelegate>
...
-(void)regist:(NSString *)phone mima:(NSString *)mima yanzhengma:(NSString *)yanzhengma
{
    ...
    if ([self.navigationItem.title isEqualToString: @"设置新密码"]) {
...
- (void)getVerificationCode:(NSString *)phonenum
{
    ...
    NSString *urlString = @"http://send.18sms.com/msg/HttpBatchSendSM";
    //
    AFHTTPSessionManager *managers = [AFHTTPSessionManager manager];
